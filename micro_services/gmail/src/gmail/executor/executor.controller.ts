...
import { GmailExecutorService } from './executor.service';

@Controller()
export class GmailExecutorController {
    private readonly logger = new Logger(GmailExecutorController.name);

    constructor(
        private readonly executorService: GmailExecutorService,
    ) {}
